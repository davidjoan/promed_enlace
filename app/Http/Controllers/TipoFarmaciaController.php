...
class TipoFarmaciaController extends CrudController{
    ...
    public function all($entity){
		...
		$this->filter = \DataFilter::source(new \Enlace\TipoFarmacia);
    ...
    public function  edit($entity){
		...
		$this->edit = \DataEdit::source(new \Enlace\TipoFarmacia());

		$this->edit->label('Editar Tipo Farmacia');
